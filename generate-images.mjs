...
const ASSETS = [
  ...
  },
  {
    ...
    size: "1024x1280",
    prompt: `A vertical rectangular photograph that depicts a heritage medispa interior, but with a critical compositional rule: the interior view is contained inside an ASYMMETRIC ARCHED PORTAL OPENING that fills only the LEFT 75% of the frame. The remaining RIGHT 25% of the frame is solid PALE WARM CREAM PLASTER WALL (approximately hex #F5EFE6 / RGB 245 239 226 — very pale ivory cream). The BOUNDARY between the interior view and the cream wall is a TALL SMOOTH ARCH CURVE: starting at the top of the frame about 75% across, curving outward to the right, and curving back to meet the bottom of the frame about 75% across — like the edge of a heritage doorway viewed straight on. The TOP of the frame above the arch curve is also solid cream wall extending fully across; the BOTTOM below the arch curve is also solid cream wall. Inside the arched opening, the visible interior shows: a sputnik chandelier with multiple frosted glass globes hanging from a high white ceiling, a tall arched heritage window in the distance with sheer light, pale blonde-oak parquet floor, a single cream upholstered armchair on the right, a small round travertine coffee table with a single olive sprig in a clear vase. Soft natural daylight from the window. The cream wall surrounding the arch on the right, top, and bottom must be perfectly flat, smooth, evenly lit pale cream — no texture, no shadows, no architectural details on it. Editorial luxury photography. Vertical orientation 1024x1280. NO TEXT, NO LOGOS, NO PEOPLE.`,
  },
  {
    file: "map.png",
    size: "1024x1024",
